...
<div class="row">
    ...
    <div class="col-md-7">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <?php $page_no=$this->Paginator->current('Roles'); $page_no=($page_no-1)*20; ?>
                 <table id="example1" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__(' <i class="fa fa-edit"></i>'), ['action' => 'index', $EncryptingDecrypting->encryptData($role->id)],['class'=>'btn btn-info editbtn','escape'=>false, 'data-widget'=>'Edit Role', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit Role']) ?>
                            </td>
                        </tr>
                    <?php $i++; endforeach; ?>
                    </tbody>
