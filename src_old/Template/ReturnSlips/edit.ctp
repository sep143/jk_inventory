                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php echo $this->Form->control('employee_id',[
                                        'label' => false,'class'=>'form-control qty','placeholder'=>'Enter quantity','type'=>'text','required','value'=>$returnSlip->employee->name,'readonly']);
                                ?>
                                
                                <?php echo $this->Form->hidden('employee_id',['value'=>$returnSlip->employee_id]);  ?>
                            </div>
                        </div>
