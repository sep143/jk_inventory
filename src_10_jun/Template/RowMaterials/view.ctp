...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Row Material'), ['action' => 'edit', $rowMaterial->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Row Material'), ['action' => 'delete', $rowMaterial->id], ['confirm' => __('Are you sure you want to delete # {0}?', $rowMaterial->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Row Materials'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Row Material'), ['action' => 'add']) ?> </li>
        <li><?= $this->Html->link(__('List Row Material Categories'), ['controller' => 'RowMaterialCategories', 'action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Row Material Category'), ['controller' => 'RowMaterialCategories', 'action' => 'add']) ?> </li>
...
<div class="rowMaterials view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Row Material Category') ?></th>
