...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Row Material Category'), ['action' => 'edit', $rowMaterialCategory->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Row Material Category'), ['action' => 'delete', $rowMaterialCategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $rowMaterialCategory->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Row Material Categories'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Row Material Category'), ['action' => 'add']) ?> </li>
...
<div class="rowMaterialCategories view large-9 medium-8 columns content">
    ...
    <div class="related">
        <h4><?= __('Related Row Materials') ?></h4>
        <?php if (!empty($rowMaterialCategory->row_materials)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Name') ?></th>
                <th scope="col"><?= __('Row Material Category Id') ?></th>
