                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                     ...
                                     <div class="col-sm-2">
                                        ...
                                        <?php echo $this->Form->control('data[admin_approve_flag]', ['options' =>$status, 'empty' =>'--Select--','label'=>false,'class'=>'form-control','style'=>'width:100%;',]);?>
                                    </div>
                                    <div class="col-sm-1">
                                       <?= $this->Form->submit('SEARCH',['class'=>'btn btn-info btnClass','style'=>'margin-top:28px;'])?>
                                    </div>
                                    <div class="col-sm-1">
                                       <?= $this->Html->link(__('RESET'), ['action' => 'requestApprovalAdmin'],['class'=>'btn btn-danger btnClass','escape'=>false, 'data-widget'=>'Reset', 'data-toggle'=>'tooltip', 'data-original-title'=>'Reset','style'=>'margin-top:28px;']) ?>
                                    </div>
                                </div>
                                <?= $this->Form->end(); ?>
                            </div>
