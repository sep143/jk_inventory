		...
		<div class="form-box" id="login-box" style="background-color:#2C2948 !important;width:384px !important;">
			...
			<div class="body" style="background-color:#2C2948 !important;padding: 40px 30px 20px 30px;">
				<div class="row col-md-12 text-center">
					<label style="color:white;font-size: 20px;margin-bottom:15px;"> LOGIN</label>
				</div>
				<div class="form-group">
				<!-- <span class="input-group-addon form-control">
					<i class="fa fa-user" style="color: #C9CACB !important;"></i>
				</span> -->
					<?= $this->Form->input('username',['id'=>'username','class'=>'form-control inputstyle','placeholder'=>'  Username','required'=>true,'label'=>false]); ?>
				...
				<!-- <span class="input-group-addon form-control">
					...
					<?= $this->Form->input('password',['id'=>'password','class'=>'form-control inputstyle','placeholder'=>'  Password','required'=>true,'label'=>false]); ?>
				</div>
			</div>
			
			<div class="footer" style="background-color:#2C2948 !important;margin-bottom: 20px !important;"> 
				<?= $this->Form->button('LOGIN',['id'=>'submit','class'=>'btn btn-lg btn-block']); ?>
				
				<center>
					<?php  //echo $this->Html->link("Forgot password?<br/>", array('controller' => 'Employees', 'action' => 'forgot_password'),['class' => '','style'=>'width:100%;color:white !important;padding:20px !important;','escape'=>false]); ?>
				</center>
	        </div>
	        <?= $this->Form->end() ?>
        </div>
