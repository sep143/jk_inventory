                    ...
                    <div class="tab-content">
                        ...
                        <?php echo $this->Form->create($userRight, ['url'=>['action'=>'addEmployeeRights'],'type' => 'post','class'=>'form-horizontal']); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    echo $this->Form->input('employee_id', ['empty'=> '--Select--','data-placeholder'=>'Select ID...','label' => false,'class'=>'select2 employee_id','style'=>'width:100%;','id'=>'employee_id','required'=>true]); ?>
                        ...
                        <?php echo $this->Form->create($userRight, ['url'=>['action'=>'addRoleRights'],'type' => 'post','class'=>'form-horizontal']); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php 
                                    echo $this->Form->input('role_id', ['empty'=> '--Select--','data-placeholder'=>'Select Role...','label' => false,'class'=>'select2 role_id','style'=>'width:100%;','id'=>'role_id','required'=>true]); ?>
                                    <span class="help-block">
