                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <?php $j=1; foreach ($requisitionSlip->requisition_slip_rows as $requisitionSliprow){ ?>
                                                            <tr>
                                                                ...
                                                                <td style="width:45%;"><?php echo $requisitionSliprow->row_material->name ;?></td>
                                                                <td style="width:20%;"><?php echo $requisitionSliprow->quantity.' '.$requisitionSliprow->row_material->unit->name ;?></td>
                                                                <td style="width:25%;"><?php echo $requisitionSliprow->description; ?></td>
                                                            </tr>
                                                             <?php $j++; } ?>
                                                        </tbody>
                                                    </table>
