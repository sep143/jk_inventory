                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <?php echo $this->Form->create('', [
                                            'url' => ['controller' => 'MaterialTransferSlips', 'action' => 'delete',$EncryptingDecrypting->encryptData($returnSlip->id)]
                                        ]); ?>
                                          <div class="modal-dialog modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                    <h4> Are you sure, you want to delete this material transfer slip ? </h4>
                                              </div>
                                              ...
                                              <div class="modal-body" id="printModel<?php echo $returnSlip->id ;?>">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td >Voucher No. - <?= 'MT-'.h($returnSlip->voucher_no) ?></td>
                                                            <td colspan="2" style="text-align: right;">Transaction Date - <?= h($returnSlip->transaction_date) ?></td>
                                                        <tr>
                                                            <tr>
                                                                <th scope="col">Sr.No</th>
