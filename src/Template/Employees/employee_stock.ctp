...
$filename="Employee_stock_".$date.'_'.$time;
                        ...
                        <div class="col-md-12">
                            <?= $this->Form->create('$po_data',['type'=>'GET']) ?>
                                ...
                                {?>
                                    ...
                                    <div class="col-md-1">
                                        <?= $this->Html->link(__('RESET'), ['action' => 'employee-stock'],['class'=>'btn btn-danger btnClass','escape'=>false, 'data-widget'=>'Reset', 'data-toggle'=>'tooltip', 'data-original-title'=>'Reset','style'=>'margin-top:28px;']) ?>
                                    </div>
                                <?php  } ?>
                                    <div class="col-md-1">
                                        <?php echo  $this->Html->link( '<i class="fa fa-file-excel-o"></i> Excel', '/Employees/employee-stock/'.@$url_excel.'&status=excel',['class' =>'btn btn-success btnClass','target'=>'_blank','escape'=>false,'data-original-title'=>'Download as excel','style'=>'margin-top:28px;']); ?>
                                    </div>
                                </div>
                                <!-- <div class="row">
...
<?php } ?>
            ...
            //pr($row_material_list);exit;
            ?>
            <div class="box-body">
                <div class="form-group">
                <?php if(!empty($employeename)){
                    echo '<h3>Name: '.$employeename->name.'</h3>';
                } ?>
