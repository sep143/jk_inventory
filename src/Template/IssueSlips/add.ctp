    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border" >
                <label> Create Issue Slip</label>
            </div><hr>
            <div class="box-body">
                <div class="form-group">
                    <?= $this->Form->create($issueSlip,['id'=>'ServiceForm']) ?>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <label class="control-label"> Issue To <span class="required" aria-required="true"> * </span></label>
                                 <?php echo $this->Form->control('employee_id',['options' => $employees,
                                    'label' => false,'class'=>' select2','empty'=>'Select Employee','style'=>'width:300px;','required']);?>
                            </div>
                        </div>
     ...
     <tbody>
        <tr class="main_tr1">
            ...
            <td>
                ...
                'label' => false,'class'=>'form-control qty','placeholder'=>'Enter quantity','type'=>'text','style'=>'width:200px;']);?>
            </td>
             <td>
                <?php echo $this->Form->control('description',[
                'label' => false,'class'=>'form-control ','placeholder'=>'Enter Particulars','type'=>'textarea','rows'=>'3']);?>
            </td>
            <td>
                <center>
