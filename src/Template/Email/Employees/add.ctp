                    ...
                    <?= $this->Form->create($employee,['id'=>'ServiceForm']) ?>
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    'label' => false,'class'=>'form-control ','placeholder'=>'Enter Username','type'=>'password']);?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?= $this->Form->control('department_id',array('options' => $departments,'class'=>'select2','empty'=>'Select Department','label'=>false,'style'=>'width:100%')) ?>
